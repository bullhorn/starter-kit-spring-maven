 ...
 */
public class EditOnlyFields<E extends BullhornEntity, H extends RestTriggerHelper<E>, T extends AbstractTriggerTraverser<E, H>> extends Task<T> {

    private final Set<String> fields;

    public EditOnlyFields(Set<String> fields) {
        this.fields = fields;
    }
    ...
    protected void handle(T tasks) {
        ...
        if(!modifiedDisabledFields.isEmpty()) {
            tasks.addFormResponse("error:disabledfields", "Please go to the edit screen to perform this change.");
        }
    }
}
