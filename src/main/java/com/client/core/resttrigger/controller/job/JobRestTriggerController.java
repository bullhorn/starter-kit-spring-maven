...
public class JobRestTriggerController extends AbstractRestTriggerController<JobOrder, JobOrderRestTriggerTraverser> {

    private final Logger log = Logger.getLogger(JobRestTriggerController.class);

    @Autowired
    public JobRestTriggerController(@Qualifier("jobRestValidationWorkflow") Node<JobOrderRestTriggerTraverser> jobValidationWorkflow) {
