...
public class ClientCorporationRestTriggerHelper extends ClientCorporationTriggerHelper implements RestTriggerHelper<ClientCorporation> {
	...
	public ClientCorporationRestTriggerHelper(Integer entityID, Map<String, Object> valuesChanged, Integer updatingUserID,
	...
	protected ClientCorporation instantiateNewEntity() {
		return TriggerUtil.populateEntity(entityID, ClientCorporation.class, valuesChanged, ClientCorporation::new, getFields(ClientCorporationRelatedEntity.CLIENT_CORPORATION));
	}
