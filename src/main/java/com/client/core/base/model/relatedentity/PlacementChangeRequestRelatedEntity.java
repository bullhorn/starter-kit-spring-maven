...
public enum PlacementChangeRequestRelatedEntity implements BullhornRelatedEntity {
    PLACEMENT_CHANGE_REQUEST("id", "requestStatus", "requestType", "placement(id)"),
    PLACEMENT(
    ...
    PlacementChangeRequestRelatedEntity(String... standardFields) {
