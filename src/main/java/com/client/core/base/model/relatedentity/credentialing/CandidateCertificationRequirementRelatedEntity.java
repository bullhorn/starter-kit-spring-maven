...
public enum CandidateCertificationRequirementRelatedEntity implements BullhornRelatedEntity {
    CANDIDATE_CERTIFICATION_REQUIREMENT(
            "userCertificationName", "userCertificationStatus", "candidate(id,name)", "candidateCertification(id,name)",
            "certification(id,name)", "modifyingUser(id,name,email)", "owner(id,name,email)"
    ),
    CANDIDATE("id", "name", "email", "phone", "owner(id,name)"),
    CANDIDATE_CERTIFICATION("id", "licenseType", "licenseNumber", "location", "name", "status"),
    ...
    CandidateCertificationRequirementRelatedEntity(String... standardFields) {
