...
/**
 * <p>Java class for clientCorporationTemplateDtoBase complex type.
 * 
...
@XmlType(name = "clientCorporationTemplateDtoBase", propOrder = {
    "categoryID",
    "description"
})
@XmlSeeAlso({
    ClientCorporationTemplateDto.class
})
public abstract class ClientCorporationTemplateDtoBase
