...
public abstract class DataEvent {
    ...
    public static class EventMetadata {
        ...
        protected List<DataEvent.EventMetadata.Entry> entry;
         ...
         * {@link DataEvent.EventMetadata.Entry }
         * 
         * 
         */
        public List<DataEvent.EventMetadata.Entry> getEntry() {
            if (entry == null) {
                entry = new ArrayList<DataEvent.EventMetadata.Entry>();
            }
            return this.entry;
        }
